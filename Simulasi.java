...
public class Simulasi {
    ...
    public static void main(String[] args) {
        ...
        // 2. Mensimulasikan 2 Pesanan Pelanggan (Membuat objek dari Anggota 2)
        ...
        double totalBiaya = pesanan1.getHarga() + pesanan2.getHarga();
        
        System.out.println("\n=== HASIL LOGIKA PENGHITUNGAN TOTAL BIAYA ===");
